...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    logo: '', // 导航栏logo
    repo: 'whateverrrr/whateverrrr.github.io', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'Whatever', // 必需
      link: 'https://github.com/whateverrrr', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://raw.githubusercontent.com/whateverrrr/Images/main/img/U57P16T10D105601F258DT20190830154331.jpg',
      name: 'Whatever',
      slogan: 'coder',
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Whatever | <a href="https://github.com/whateverrrr/whateverrrr.github.io/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
